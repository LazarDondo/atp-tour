...
public class TournamentDaoTest {
    ...
    public void addTournamentShouldBeOk() {
        Tournament tournament = (new Tournament(1, "Roland Garros-2020", LocalDate.of(2020, Month.APRIL, 22), LocalDate.of(2020, Month.APRIL, 30),
                testCountry, "Grand Slam", null));
    ...
    public void findAllTournamentsShouldBeOk() {
        tournamentDao.save((new Tournament(1, "Roland Garros-2020", LocalDate.of(2020, Month.APRIL, 22),
                LocalDate.of(2020, Month.APRIL, 30), testCountry, "Grand Slam", null)));
